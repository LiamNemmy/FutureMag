      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between mb-8">
          <div className="mb-8 md:mb-0">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-cyan-400 bg-clip-text text-transparent mb-4">
              URBANITE
            </h2>
            <p className="text-gray-400 max-w-md">
              Exploring the cutting edge of urban culture, technology, and design. The future is already here, just unevenly distributed.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Architecture</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-gray-400 mb-4">Get the latest articles delivered to your inbox.</p>
              <form className="flex">
                <input
                  type="email"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 mb-4 md:mb-0">© 2025 Urbanite Magazine. All rights reserved.</p>
